...
External feedback is a suggestion to evaluate, not an order — be skeptical, but check carefully.
...
If neither the codebase nor the user needs the feature, don't add it.
